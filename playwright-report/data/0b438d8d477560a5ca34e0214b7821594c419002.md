...
- Name: Configuration Integration Tests >> should handle API errors gracefully
- Location: /Users/sdiachenko/Desktop/window-pricing-final/tests/integration/configuration.test.ts:54:7
...
Locator: getByText(/invalid/i)
Expected: visible
Received: <element(s) not found>
Call log:
  - expect.toBeVisible with timeout 5000ms
  - waiting for getByText(/invalid/i)

    at /Users/sdiachenko/Desktop/window-pricing-final/tests/integration/configuration.test.ts:70:46
```
...
- text: Width (inches)
- spinbutton "Width (inches)": "-1"
- text: Height (inches)
- spinbutton "Height (inches)"
...
- text: Scale Preview (Not Actual Size) Single Door -1" × 0" Glass Door • Opening Inside
- 'heading "Total Width: -1\"" [level=6]'
- 'heading "Total Height: 0\"" [level=6]'
- text: "Door Panel: -1\" × 0\""
- separator
